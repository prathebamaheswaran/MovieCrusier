...
<body>
	<c:set var="genre" value="Science Fiction,Superhero,Romance"
		scope="application" />
	...
	<section class="body-main">
		<h1 style="padding-left: 1px;">Edit Movie</h1>
		<form name="editMovieForm" action="EditMovieServlet" method="post"
			...
			<table style="width: 100%">
				...
				<tr>
					<th style="padding-top: 25px"><label for="boxoffice">Gross
							($)</label></th>
					<th style="padding-top: 25px"><label for="active">Active</label></th>
					<th style="padding-top: 25px"><label for="dateOfLaunch">Date
							of Launch</label></th>
				...
				<tr>
					...
					<td><input type="date" name="dateOfLaunch" id="mdate"
				...
				<tr>
					<td style="padding-top: 25px"><input type="submit"
						class="button" name="submit" value="Save"></td>
				</tr>
			</table>
